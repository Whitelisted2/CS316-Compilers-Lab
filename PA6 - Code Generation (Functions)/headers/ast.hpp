...
public:
    ...
    std::string generateCode(CodeObject *code)
    {
        ...
        code->TAC.push_back(new CodeLine(code->symbolTableStack->table_stack.top()->scope, command, left, right, temp));
        return temp;
    }
};
...
public:
    ...
    {
        std::string temp = code->getTemp();
        code->TAC.push_back(new CodeLine(code->symbolTableStack->table_stack.top()->scope, "STOREI", std::to_string(this->value), temp));
        return temp;
    }
};
...
public:
    ...
    std::string generateCode(CodeObject *code)
    {
        ...
        char str[10];
        sprintf(str, "%f", value);
        code->TAC.push_back(new CodeLine(code->symbolTableStack->table_stack.top()->scope, "STOREF", str, temp));
        return temp;
    }
};
...
public:
    ...
    std::string generateCode(CodeObject *code)
    {
        ...
        if (ASTNode::id_type == "INT")
            ...
            command += "STOREF";
        code->TAC.push_back(new CodeLine(code->symbolTableStack->table_stack.top()->scope,
                                             command, 
...
public:
    ...
    std::string generateCode(CodeObject *code)
    {
        ...
        code->TAC.push_back(new CodeLine(code->symbolTableStack->table_stack.top()->scope, comm, ""));

        for(auto& node : *parameter_list) {
            std::string para = node->generateCode(code);
            code->TAC.push_back(new CodeLine(code->symbolTableStack->table_stack.top()->scope, comm, para));
        }

        code->TAC.push_back(new CodeLine(code->symbolTableStack->table_stack.top()->scope, comm + "R", ""));
        code->TAC.push_back(new CodeLine(code->symbolTableStack->table_stack.top()->scope, "JSR", funct_name));
        code->TAC.push_back(new CodeLine(code->symbolTableStack->table_stack.top()->scope, "POPR", ""));

        for(int i=0;i<(int)(*parameter_list).size();++i)
            code->TAC.push_back(new CodeLine(code->symbolTableStack->table_stack.top()->scope, "POP", ""));

        std::string temp = code->getTemp();

        code->TAC.push_back(new CodeLine(code->symbolTableStack->table_stack.top()->scope, "POP", temp)); 
...
public:
    ...
    std::string generateCode(CodeObject *code) {
        ...
        code->TAC.push_back(new CodeLine(code->symbolTableStack->table_stack.top()->scope, op, arg1, arg2, label));
        return "";
    }
};
